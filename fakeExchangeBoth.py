...
def validateSignature(headers, method, endpoint, body):
    signaturePayload = headers["X-FBAPI-TIMESTAMP"] + headers["X-FBAPI-NONCE"] + method + endpoint.replace('/api', '') + body
...
def validateOffExchangeSignature(headers, method, endpoint, body):
    ...
    if all(["X-OFF-EXCHANGE-NONCE" in headers,
        ...
        signaturePayload = headers["X-OFF-EXCHANGE-TIMESTAMP"] + headers["X-OFF-EXCHANGE-NONCE"] + method + endpoint.replace('/api/v' + CURRENT_VERSION, '') + body
...
def addResponseHeaders(body, requestHeader, method, endpoint):
   ...
   # json.dumps(callback_data.data["body"],separators=(',', ':'))
    ...
    signaturePayload = requestHeader["X-OFF-EXCHANGE-TIMESTAMP"] + requestHeader["X-OFF-EXCHANGE-NONCE"] + method + endpoint.replace('/api/v' + CURRENT_VERSION, '') + body_string
...
def depostAddressGET():
    ...
    if "coinSymbol" not in params.keys():
        ...
        return json.dumps({
            "data": EXISTING_DEPOSIT_ADDRESSES[params["coinSymbol"]]
        })
    else:
...
COLLATERAL_RESPONSES = {
    POST_COLLATERAL_INITIATE_ENDPOINT : {
       # "status": False,
    #    "rejectionReason": "testing error propagation"
    },
        ...
        "to_exchange": [
            #{
               ...
               # "destinationTag": "0934507FB81E2F8C27D6"
                #"destinationAddress": "rLNkYgVwDnXBBoprfMTyZv84QRTSkL9MXz",
                #"destinationTag": "25878995"
                #"destinationAddress": "GDWILVMB3MPWOBL5QUCT5YVR4RM75DE26RBWASHU5QVJO7YBYVE5NL2Y",
                #"destinationTag": "3364586178"
            #}
        ],
        "to_collateral": [
            {
    ...
    "capabilities": [
        ...
        },
        {
            ...
            "withdrawal": {
                ...
                "transferMethod": "InternalTransfer",
                "destinationPolicy": "DirectParentAccount"
            },
            "balanceAsset": {
                "blockchain": "Ethereum",
                "cryptocurrencySymbol": "ETH",
...
GET_DEPOSIT_METHODS_ENDPOINT: {
    ...
    "balanceAmount": "3",
    "status": "succeeded",
    "createdAt": "2025-03-03T16:45:22Z",
    "finalizedAt": "2025-03-03T47:15:22Z",
    "events": [
        {
        "status": "pending",
        "message": "3",
        "createdAt": "2025-03-03T46:15:22Z"
        }
    ],
    "destination": {
        "asset": {
    ...
    #"rejectionReason": "deposit amount is too small"
    },
...
def collateral_initiate():
    ...
    return addResponseHeaders(response, request.headers, POST_COLLATERAL_INITIATE_METHOD, POST_COLLATERAL_INITIATE_ENDPOINT), code
...
def collateral_address():
    ...
    # Add response headers and return the modified response
    return addResponseHeaders(response_data, request.headers, POST_COLLATERAL_ADDRESS_METHOD,POST_COLLATERAL_ADDRESS_ENDPOINT), code
...
def collateral_add():
    ...
    # Add response headers and return the modified response
    return addResponseHeaders(response_data, request.headers, POST_COLLATERAL_ADD_METHOD,POST_COLLATERAL_ADD_ENDPOINT), code
...
def collateral_withdraw():
    ...
    # Add response headers and return the modified response
    return addResponseHeaders(response_data, request.headers, POST_COLLATERAL_WITHDRAW_METHOD, POST_COLLATERAL_WITHDRAW_ENDPOINT), code
...
def collateral_settlement():
    ...
    # Add response headers and return the modified response
    return addResponseHeaders(response_data, request.headers, POST_COLLATERAL_SETTLEMENT_METHOD, POST_COLLATERAL_SETTLEMENT_ENDPOINT), code
...
def collateral_enforce_settlement():
    ...
    # Add response headers and return the modified response
    return addResponseHeaders(response_data, request.headers, POST_COLLATERAL_ENFORCE_SETTLEMENT_METHOD, POST_COLLATERAL_ENFORCE_SETTLEMENT_ENDPOINT), code
...
def get_collateral_settlement():
    ...
    # Add response headers and return the modified response
    return addResponseHeaders(response_data, request.headers, GET_COLLATERAL_SETTLEMENT_METHOD, GET_COLLATERAL_SETTLEMENT_ENDPOINT), code
...
def get_capabilities_liquidity_quotes(accountId='1',id='1',collateralId='1',collateralTxId='1',settlementVersion='1'):
...
def get_sub_account(accountId='1',id='1',collateralId='1',collateralTxId='1',settlementVersion='1'):
    ...
    if accountId == '2':
        return json.dumps(COLLATERAL_RESPONSES[GET_SUB_ACCOUNT_ENDPOINT2])
    if accountId == '3':
        return json.dumps(COLLATERAL_RESPONSES[GET_SUB_ACCOUNT_ENDPOINT3])
...
def post_transfer_withdrawals_blockchain(accountId='1',id='1',collateralId='1',collateralTxId='1',settlementVersion='1'):
...
def post_transfer_withdrawals_peeraccount(accountId='1',id='1',collateralId='1',collateralTxId='1',settlementVersion='1'):
...
def post_transfer_withdrawals_subaccount(accountId='1',id='1',collateralId='1',collateralTxId='1',settlementVersion='1'):
    logging.debug('SubTransfer test')
    logging.debug(request.get_json())
...
def get_account_transfers_withdrawals(accountId='1',id='1',collateralId='1',collateralTxId='1',settlementVersion='1'):
...
def get_account_transfers_withdrawals_id(accountId='1',id='1',collateralId='1',collateralTxId='1',settlementVersion='1'):
...
@app.route(POST_ACCOUNT_TRANSFERS_DEPOSITS_ADDRESSES_ENDPOINT, methods=[POST_ACCOUNT_TRANSFERS_DEPOSITS_ADDRESSES_METHOD])
def post_account_transfers_deposits_addresses(accountId='1',id='1',collateralId='1',collateralTxId='1',settlementVersion='1'):
...
def get_account_transfers_deposits_addresses(accountId='1',id='1',collateralId='1',collateralTxId='1',settlementVersion='1'):
...
@app.route(GET_ACCOUNT_TRANSFERS_DEPOSITS_ADDRESSES_ID_ENDPOINT, methods=[GET_ACCOUNT_TRANSFERS_DEPOSITS_ADDRESSES_ID_METHOD])
def get_account_transfers_deposits_addresses_id(accountId='1',id='1',collateralId='1',collateralTxId='1',settlementVersion='1'):
    limit = check_limit('get_account_transfers_deposits_addresses_id')

    if limit:
        return json.dumps({list(COLLATERAL_RESPONSES[GET_ACCOUNT_TRANSFERS_DEPOSITS_ADDRESSES_ID_ENDPOINT].keys())[0]: []})
...
def post_account_collateral_id_addresses(accountId='1',id='1',collateralId='1',collateralTxId='1',settlementVersion='1'):
    request_data = request.get_json() or {}
    print(request_data)
    app.logger.info("START POST ADDRESS")
    app.logger.info(request_data)
    app.logger.info("POLINA POLINA POLINA !!!!!!")
...
def get_account_collateral_id_addresses(accountId='1',id='1',collateralId='1',collateralTxId='1',settlementVersion='1'):
...
@app.route(POST_ACCOUNT_COLLATERAL_ID_INTENT_DEPOSITS_ENDPOINT, methods=[POST_ACCOUNT_COLLATERAL_ID_INTENT_DEPOSITS_METHOD])
def post_account_collateral_id_intent_deposits(accountId='1',id='1',collateralId='1',collateralTxId='1',settlementVersion='1'):
    ...
    @app.route(GET_CAPABILITIES_TRADING_BOOKS_ENDPOINT, methods=[GET_CAPABILITIES_TRADING_BOOKS_METHOD])
    def get_capabilities_trading_books(accountId='1', id='1', collateralId='1', collateralTxId='1',
                                       settlementVersion='1'):
        limit = check_limit('get_capabilities_trading_books')
    ...
    @app.route(POST_TRANSFER_WITHDRAWALS_FIAT_ENDPOINT, methods=[POST_TRANSFER_WITHDRAWALS_FIAT_METHOD])
    def post_transfer_withdrawals_fiat(accountId='1', id='1', collateralId='1', collateralTxId='1',
                                       settlementVersion='1'):
        return json.dumps(COLLATERAL_RESPONSES[POST_TRANSFER_WITHDRAWALS_FIAT_ENDPOINT])
    ...
    @app.route(GET_ACCOUNT_TRANSFERS_DEPOSITS_ADDRESSES_ENDPOINT,
               methods=[GET_ACCOUNT_TRANSFERS_DEPOSITS_ADDRESSES_METHOD])
    def get_account_transfers_deposits_addresses(accountId='1', id='1', collateralId='1', collateralTxId='1',
        ...
        if limit:
            return json.dumps(
                {list(COLLATERAL_RESPONSES[GET_ACCOUNT_TRANSFERS_DEPOSITS_ADDRESSES_ENDPOINT].keys())[0]: []})
        return json.dumps(COLLATERAL_RESPONSES[GET_ACCOUNT_TRANSFERS_DEPOSITS_ADDRESSES_ENDPOINT])
    ...
    @app.route(POST_ACCOUNT_COLLATERAL_LINK_ENDPOINT, methods=[POST_ACCOUNT_COLLATERAL_LINK_METHOD])
    def post_account_collateral_link(accountId='1', id='1', collateralId='1', collateralTxId='1',
                                     settlementVersion='1'):
        request_data = request.get_json() or {}
        print(request_data)
        collateral_id = request_data.get('collateralId')
    ...
    def post_account_collateral_id_deposits(accountId='1', id='1', collateralId='1', collateralTxId='1',
        ...
        request_data = request.get_json() or {}
        print(request_data)
        app.logger.info("POST COLLATERAL DEPOSITS")
        app.logger.info(request_data)
    ...
    def get_account_collateral_id_withdrawals(accountId='1', id='1', collateralId='1', collateralTxId='1',
        ...
        if limit:
            return json.dumps(
                {list(COLLATERAL_RESPONSES[GET_ACCOUNT_COLLATERAL_ID_WITHDRAWALS_ENDPOINT].keys())[0]: []})
    ...
    def get_account_collateral_id_withdrawals_txid(accountId='1', id='1', collateralId='1', collateralTxId='1',
        ...
        # if limit:
        # return json.dumps({list(COLLATERAL_RESPONSES[GET_ACCOUNT_COLLATERAL_ID_WITHDRAWALS_COLLATERALTXID_ENDPOINT].keys())[0]: []})
...
@app.route(POST_ACCOUNT_COLLATERAL_ID_DEPOSITS_ENDPOINT, methods=[POST_ACCOUNT_COLLATERAL_ID_DEPOSITS_METHOD])
def post_account_collateral_id_deposits(accountId='1',id='1',collateralId='1',collateralTxId='1',settlementVersion='1'):
    limit = check_limit('post_account_collateral_id_deposits')
...
@app.route(GET_ACCOUNT_COLLATERAL_ID_DEPOSITS_ENDPOINT, methods=[GET_ACCOUNT_COLLATERAL_ID_DEPOSITS_METHOD])
def get_account_collateral_id_deposits(accountId='1',id='1',collateralId='1',collateralTxId='1',settlementVersion='1'):
    limit = check_limit('get_account_collateral_id_deposits')
    if limit:
        return json.dumps({list(COLLATERAL_RESPONSES[GET_ACCOUNT_COLLATERAL_ID_DEPOSITS_ENDPOINT].keys())[0]: []})
    return json.dumps(COLLATERAL_RESPONSES[GET_ACCOUNT_COLLATERAL_ID_DEPOSITS_ENDPOINT])

@app.route(GET_ACCOUNT_COLLATERAL_ID_DEPOSITS_COLLATERALTXID_ENDPOINT, methods=[GET_ACCOUNT_COLLATERAL_ID_DEPOSITS_COLLATERALTXID_METHOD])
def get_account_collateral_id_deposits_txid(accountId='1',id='1',collateralId='1',collateralTxId='1',settlementVersion='1'):
    limit = check_limit('get_account_collateral_id_deposits_txid')
    collateral_tx_id =  request.args.get('collateralTxId')
    response = {
        "id": "1",
    ...
    if limit:
        return json.dumps({list(COLLATERAL_RESPONSES[GET_ACCOUNT_COLLATERAL_ID_DEPOSITS_COLLATERALTXID_ENDPOINT].keys())[0]: []})
    return json.dumps({"errorType": "not-found", "message": "read the error type..."}), 404

@app.route(POST_ACCOUNT_COLLATERAL_ID_INTENT_WITHDRAWALS_ENDPOINT, methods=[POST_ACCOUNT_COLLATERAL_ID_INTENT_WITHDRAWALS_METHOD])
def post_account_collateral_id_intent_withdrawals(accountId='1',id='1',collateralId='1',collateralTxId='1',settlementVersion='1'):
...
@app.route(POST_ACCOUNT_COLLATERAL_ID_WITHDRAWALS_ENDPOINT, methods=[POST_ACCOUNT_COLLATERAL_ID_WITHDRAWALS_METHOD])
def post_account_collateral_id_withdrawals(accountId='1',id='1',collateralId='1',collateralTxId='1',settlementVersion='1'):
    request_data = request.get_json() or {}
    print(request_data)
    collateral_tx_id = request_data.get('collateralTxId')
...
@app.route(GET_ACCOUNT_COLLATERAL_ID_WITHDRAWALS_ENDPOINT, methods=[GET_ACCOUNT_COLLATERAL_ID_WITHDRAWALS_METHOD])
def get_account_collateral_id_withdrawals(accountId='1',id='1',collateralId='1',collateralTxId='1',settlementVersion='1'):
    limit = check_limit('get_account_collateral_id_withdrawals')
...
@app.route(GET_ACCOUNT_COLLATERAL_ID_WITHDRAWALS_COLLATERALTXID_ENDPOINT, methods=[GET_ACCOUNT_COLLATERAL_ID_WITHDRAWALS_COLLATERALTXID_METHOD])
def get_account_collateral_id_withdrawals_txid(accountId='1',id='1',collateralId='1',collateralTxId='1',settlementVersion='1'):
    limit = check_limit('get_account_collateral_id_withdrawals_txid')
...
@app.route(POST_ACCOUNT_COLLATERAL_ID_SETTLEMENT_ENDPOINT, methods=[POST_ACCOUNT_COLLATERAL_ID_SETTLEMENT_METHOD])
def post_account_collateral_id_settlement(accountId='1',id='1',collateralId='1',collateralTxId='1',settlementVersion='1'):
    return json.dumps(COLLATERAL_RESPONSES[POST_ACCOUNT_COLLATERAL_ID_SETTLEMENT_ENDPOINT])

@app.route(GET_ACCOUNT_COLLATERAL_ID_SETTLEMENT_ENDPOINT, methods=[GET_ACCOUNT_COLLATERAL_ID_SETTLEMENT_METHOD])
def get_account_collateral_id_settlement(accountId='1',id='1',collateralId='1',collateralTxId='1',settlementVersion='1'):
    return json.dumps(COLLATERAL_RESPONSES[GET_ACCOUNT_COLLATERAL_ID_SETTLEMENT_ENDPOINT])

@app.route(GET_ACCOUNT_COLLATERAL_ID_SETTLEMENTS_VERSION_ENDPOINT, methods=[GET_ACCOUNT_COLLATERAL_ID_SETTLEMENTS_VERSION_METHOD])
def get_account_collateral_id_settlement_version(accountId='1',id='1',collateralId='1',collateralTxId='1',settlementVersion='1'):
    limit = check_limit('get_capabilities')

    if limit:
        return json.dumps({list(COLLATERAL_RESPONSES[GET_ACCOUNT_COLLATERAL_ID_SETTLEMENTS_VERSION_ENDPOINT].keys())[0]: []})
    return json.dumps(COLLATERAL_RESPONSES[GET_ACCOUNT_COLLATERAL_ID_SETTLEMENTS_VERSION_ENDPOINT])
